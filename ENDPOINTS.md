...
| GET | /products/{product_id} | Return specific product info | "CampusCore needs to retrieve specific product information in order to show more info when a buyer clicks on a product." |
...
| PATCH | /discounts/{product_id} | Update the discount amount for a product | "CampusCore needs to set the discount amount per item in order to manage promotions on its platform." |
