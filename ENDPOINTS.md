...
| PATCH | /discounts/{sku}/ | Update the discount amount for a product | "CampusCore needs to set the discount amount per item in order to manage promotions on its platform." |
